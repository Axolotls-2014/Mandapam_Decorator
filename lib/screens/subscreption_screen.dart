                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (selectedIndex.value == -1) {
                          ...
                          final selectedPackage = controller.packages[selectedIndex.value];
                          log("${selectedPackage.price}");
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const ReusableWebView(
                                url: 'https://mandapam.co/payment/razor-pay/pay?payment_id=8e8b5fe6-ab49-4543-81bb-99785dc3a25f',
                                title: 'payment',
                              ),
                            ),
                          );
