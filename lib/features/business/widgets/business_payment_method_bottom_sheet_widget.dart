              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // Null check for activePaymentMethodList
                    Get.find<SplashController>().configModel?.activePaymentMethodList != null
                        ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        : Center(child: Text('no_payment_methods_available'.tr)), // Fallback if activePaymentMethodList is null
                  ],
                ),
              ),
            ),
