...
import 'package:sixam_mart/features/item/screens/bottom_sheet_widget.dart';
    ...
    return GetBuilder<CartController>(builder: (cartController) {
      return GetBuilder<ItemController>(
        builder: (itemController) {
          ...
          return Scaffold(
            ...
            body: SafeArea(
                child: (itemController.item != null)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Builder(builder: (context) {
                                        print(
                                            'Item being passed to ItemTitleViewWidget:');
                                        print(
                                            'Item ID: ${itemController.item?.id}');
                                        print(
                                            'Item Name: ${itemController.item?.name}');
                                        print(
                                            'Item Name: ${itemController.item?.userName}');
                                        print(
                                            'Item Price: ${itemController.item?.price}');
                                        print('Item Stock: $stock');
                                        print(
                                            'Is Campaign: ${itemController.item?.availableDateStarts != null}');
                                        print(
                                            'In Stock: ${!(Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! && stock! <= 0)}');
                                                    ...
                                                    children: [
                                                      ...
                                                      InkWell(
                                                        onTap: () {
                                                          ...
                                                          log('ganesh : ${itemController.item!.quantityLimit}/${itemController.quantity}');
                                                          if (itemController
                                                              .item!
                                                              .quantityLimit! >
                                                              itemController
                                                                  .quantityy!) {
                                                            showCountBottomSheet(
                                                              context,
                                                              itemController,
                                                              cartController,
                                                              stock ??
                                                            ...
                                                            ScaffoldMessenger.of(context)
                                                                .showSnackBar(
                                                              SnackBar(
                                                                  content: Text("Maximum quanity limit:${itemController.item!.quantityLimit}")),
                                                            );
                                                          }
                                                        },
                                                        child:
                                      ...
                                      const SizedBox(
                                          height: Dimensions
                                              .paddingSizeLarge),
                                      //
                                      // Text('Delivery Time', style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                      // const SizedBox(height: 5.0),
                                      // Text('${itemController.item!.delivery_time}', style: robotoRegular),
                                      ...
                                      itemController.item!
                                        ...
                                        children: [
                                          ...
                                          //   children: [
                                          //     Text('Contact Details', style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                          //     InkWell(
                                          //       onTap: () {
                                          //         String phoneNumber = itemController.item!.storePhone ?? '';
                                          ...
                                          //         child: Icon(Icons.call, size: 24, color: Colors.blue),
                                          //       ),
                                          //     ),
                                          //   ],
                                          // ),
                                          // const SizedBox(height: 5.0),
                                          // Text('${itemController.item!.storePhone}', style: robotoRegular),
                                          // const SizedBox(height: Dimensions.paddingSizeLarge),

                                          // Text('Address', style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                          // const SizedBox(height: 5.0),
                                          // Text('${itemController.item!.storeAddress}', style: robotoRegular),
                                          // const SizedBox(height: Dimensions.paddingSizeLarge),
                                        ],
                                      )
                                          : Row(children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                              '${itemController.item!.deliveryTime}',
                                              style: robotoRegular),
                                          const SizedBox(
                                              width: Dimensions
                                                  .paddingSizeLarge),
                  ...
                  // itemController.item!.productType != "Rental"
          ...
          /// 🔥 DIRECTLY add/update cart (no dialog)
          ...
          const errorMessage = 'You can only choose 1 item';
