                  ...
                  Expanded(child: SingleChildScrollView(
                      ...
                      child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(
                        ...
                        children: [
                          ...
                          // Quantity
                          itemController.item!.productType != "Rental" ? GetBuilder<CartController>(
                              builder: (cartController) {
                                return Row(children: [
                          ...
                          itemController.item!.productType == "Rental" ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Row(
                          ...
                          Row(
                            children: [
                              ...
                              Text('${itemController.item!.deliveryTime}', style: robotoRegular),
