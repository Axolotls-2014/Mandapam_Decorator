...
class FavouriteController extends GetxController implements GetxService {
  ...
  List<Item?>? get wishItemList => _wishItemList != null
      ? List<Item?>.from(_wishItemList!.reversed)
      : null;

  List<Store?>? get wishStoreList => _wishStoreList != null
      ? List<Store?>.from(_wishStoreList!.reversed)
      : null;

  List<int?> get wishItemIdList => List<int?>.from(_wishItemIdList.reversed);
  List<int?> get wishStoreIdList => List<int?>.from(_wishStoreIdList.reversed);
