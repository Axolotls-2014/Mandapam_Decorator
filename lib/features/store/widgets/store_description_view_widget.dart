    ...
    return Column(children: [
      ResponsiveHelper.isDesktop(context) ? Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Expanded(child: Text(
              store!.userName!, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: textColor),
     ...
     IntrinsicHeight(
       child: Row(children: [
         ...
         InkWell(
           onTap: () => Get.toNamed(RouteHelper.getStoreReviewRoute(store!.id, store!.userName, store!)),
