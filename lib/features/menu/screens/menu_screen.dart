...
import 'package:sixam_mart/features/media/batch_list.dart';
                    ...
                    isLoggedIn ? Text(
                      ...
                      onTap: () async {
                        if(!ResponsiveHelper.isDesktop(context)) {
                          await  Get.offAllNamed(RouteHelper.getSignInRoute(RouteHelper.splash));
              ...
              child: Column(children: [
                      ...
                      PortionWidget(
                        ...
                        onTap: () async {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              // builder: (context) => BatchListScreen(sharedPreferences: prefs),
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      PortionWidget(
                        icon: Images.couponIcon, title: 'Coupon for purchase', route: RouteHelper.getCouponRoute(),
